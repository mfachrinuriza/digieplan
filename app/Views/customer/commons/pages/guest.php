                              ...
                              <tbody class="table-tbody">
                                ...
                                foreach ($guestList as $guest) {
                                  ...
                                  <tr valign="middle" id="row-guest">
                                    ...
                                    <td width="55%">'.$guest['name'].' & '.$guest['invite_with'].' <kbd class="'.$statusStyle.'">'.$guest['status'].'</kbd></td>
                                    <td width="25%" class="text-center">
                                      ...
                                      <button class="btn btn-outline-secondary getURLData" data-url="'.$profileGroom['nickname'].'dan'.$profileBride['nickname'].'.digieplan.com'.'/wedding-invitation?to='.$guest['name'].' & '.$guest['invite_with'].'" data-validation="'.$isValid.'">
                                        &nbsp;&nbsp;&nbsp; 
