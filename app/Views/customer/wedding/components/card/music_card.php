    ...
    <div class="card-body">
        <div class="divide-y">
            <div>
                <div class="row">
                    <div class="col-auto">
                        <span class="avatar rounded-circle" style="background-image: url(<?= base_url('public').'/assets/images/singer/'.$music['image_singer'] ?>)"></span>
                    </div>
                    <div class="col">
                    ...
                    <div class="col-auto">
                        <div id="music-play" class="border-0" style="background-color: transparent;" onclick="playMusicButton('<?= $music['music_path']?>', 'music-play<?= $music['id'] ?>')">
                            <img class="avatar rounded-circle" id="music-play<?= $music['id'] ?>" src="<?= base_url('public'); ?>/assets/images/icon/play-button.png"></img>
                        </div>
                    </div>
