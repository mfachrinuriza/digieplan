<!-- Start Create Event -->
<div class="modal modal-blur fade" id="modal-profile-create" tabindex="-1" role="dialog" aria-hidden="true" onload="disableYesterday()">
        ...
        <div class="modal-content">
            <form action="<?= base_url('/customer/kelola-konten-undangan/profil/create')?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3" id="dropzone-profile-create">
