                            ...
                            <div class="row">
                                ...
                                <div class="<?= $url_image != null ? "card" : "" ?> col-md-4 p-0" style="aspect-ratio: 8 / 13;">
                                    <form action="<?= base_url('/customer/kelola-konten-undangan/halaman-utama/create')?>" method="POST" enctype="multipart/form-data">
                                        <a class="p-0 m-0 border-0 bg-transparent" onclick="buttonSelectCoverImage()">
                                            ...
                                            <input type="file" name="image_cover" id="input-cover-image" onchange="requestSubmitCoverImage()" accept="image/*" hidden>
                                        ...
                                        <button id="button-submit-cover" hidden></button>
                                    </form>
                                </div>
                            </div>
                        </div>
