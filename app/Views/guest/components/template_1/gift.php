        ...
        foreach ($giftList as $gift) {
            if ($gift['type'] == "Bank") {
                ...
                <div class="gift_card">
                  ...
                  <button id="copy_rekening" rek-number=' . $gift['account_number'] . ' class="variant_1_button" type="button"><img src="' . base_url('public/AssetsGuest/image/copy.svg') . '" width="12" />SALIN NO. REK</button>
                </div>
                ';
