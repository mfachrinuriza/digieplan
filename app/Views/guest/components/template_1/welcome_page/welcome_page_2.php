<section id="welcomePage_2" class="welcomePage">
    <div id="welcomaPage_2_content_top_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_2_top.svg') ?>"></div>
    <div id="welcomaPage_2_content_side_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_2_left.svg') ?>"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_2_right.svg') ?>"></div>
    ...
    <div id="welcomaPage_2_content_bottom_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_4_bottom.svg') ?>" width="100%"></div>
</section>