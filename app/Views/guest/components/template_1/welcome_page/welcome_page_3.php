<section id="welcomePage_3" class="welcomePage">
    <div id="welcomaPage_3_content_top_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_3_top.svg') ?>"></div>
    <div id="welcomaPage_3_content_center_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_3_center.svg') ?>"></div>
    ...
    <div id="welcomaPage_3_content_bottom_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_2_3_bottom.svg') ?>" width="100%"></div>
</section>