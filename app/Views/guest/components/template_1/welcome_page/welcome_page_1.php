<section id="welcomePage" class="welcomePage">
    <div id="welcomaPage_content_top_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_top_left.svg') ?>"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_top_right.svg') ?>"></div>
    ...
    <div id="welcomaPage_content_bottom_image"><img src="<?= base_url('public/AssetsGuest/image/template_a/welcome_bottom.svg') ?>" width="100%"></div>
</section>