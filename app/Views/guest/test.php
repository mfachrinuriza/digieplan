...
<body>
    <main>
        ...
        <section id="countDown">
            ...
            <div id="countDown_content">
                ...
                <hr>
                <p id="countDown_date" attr-val="2024-02-30 15:00:00">13.10.2023</p>
                ...
                <p id="countDown_text" >
                    Tuhan membuat segala sesuatu indah pada waktu-Nya. Indah saat Dia mempertemukan. Indah saat Dia menumbuhkan cinta kasih. Indah pula Saat Dia menyatukan kami dalam pernikahan kudus.
                </p>
            </div>
        </section>
        ...
        <section id="bride">
            <div id="first_bride">
                <div class="bride_image">
                    <img class="bride_image_frame" src="<?= base_url('public/AssetsGuest/image/frame_1.svg')?>">
                    <img class="bride_image_bride" src="<?= base_url('public/AssetsGuest/image/wedding-dresses-1486256_1280.jpg')?>">
                </div>
                
                <h4>Rian</h4>
                <h2>RIAN PH.D</h2>
                <hr>
                <p class="bride_parent">PUTRA PERTAMA BAPAK RIAN DAN BAPAK RIAN</p>
                <div class="bride_instagram"><img class="bride_image_frame" src="<?= base_url('public/AssetsGuest/image/instagram.svg')?>" height="13"> <P> @RIAN.PHD</P></div>
            </div>
           <div id="second_bride">
                <div class="bride_image">
                    <img class="bride_image_frame" src="<?= base_url('public/AssetsGuest/image/frame_1.svg')?>">
        ...
        <section id="weddingStory">
            ...
            <img id="weddingStory_couple" src="<?= base_url('public/AssetsGuest/image/wedding-6173363_1280.jpg')?>" width="100%" >
            <h5 class="animate__animated">DESEMBER 2020</h5>
            <p class="animate__animated">The long barrow was built on land previously inhabited in the Mesolithic period. It consisted of a sub-rectangular earthen tumulus, estimated to have been 15 metres (50 feet) in length, with a chamber built from sarsen megaliths.</p>
        </section>
        <img class="separator" style="padding-bottom: 40px;" src="<?= base_url('public/AssetsGuest/image/separator.svg')?>" width="80%">
        <section id="date">
            ...
            <div id="date_container">
                ...
                <button id="date_map" class="variant_1_button" type="button" onclick="location.href='https://maps.app.goo.gl/JxV9Q6htWen5mW6g7'">VIEW ON MAPS</button>
        ...
        <section id="gift">
            ...
            <div id="gift_card_container">
                <div class="gift_card">
                    ...
                    <button id="copy_rekening" rek-number="12122211" class="variant_1_button" type="button"><img src="<?= base_url('public/AssetsGuest/image/copy.svg')?>" width="12">SALIN NO. REK</button>
                </div>
                <div class="gift_card">
                    <h3>GIFT</h3>
                    <div class="gift_card_info">
                        ...
                        <h5>NADINE</h5>
                        <p id="address" class="gift_gift_card_info_an">4517 Washington Ave. Manchester, Kentucky 39495</p>
                    </div>
                    <button id="copy_adrress" class="variant_1_button" type="button"><img src="<?= base_url('public/AssetsGuest/image/copy.svg')?>" width="12"> SALIN ALAMAT</button>
                </div>
            </div>
        </section>
        ...
        <section id="rsvp">
            ...
            <form id="rsvp_form" onsubmit="() => e.preventDefault(); return false">
                <div class="rsvp_input_group">
                    <label class="rsvp_label">
                        NAMA <span>*</span>
                    </label>
                    <input class="rsvp_input" placeholder="NAMA" name="nama" type="text">
                </div>
                <div class="rsvp_input_group">
                    <label class="rsvp_label">
                        Konfirmasi Kehadiran <span>*</span>
                    </label>
                    <select class="rsvp_select_input" name="confirmation" >
                ...
                <div class="rsvp_input_group">
                    ...
                    <input class="rsvp_input" name="amount" type="number">
                </div>
                <div class="rsvp_input_group">
                    <label class="rsvp_label">
                        MAKE A WISH <span>*</span>
                    </label>
                    <textarea max-word="500" id="rsvp_text_area_input" class="rsvp_text_area_input" name="wish" rows="4" placeholder="WRITE A WISH"></textarea>
                    <div id="rsvp_the_count">
                        <span id="rsvp_the_count_current">0</span>
                        <span id="rsvp_the_count_maximum">/ 500</span>
                      </div>
                </div>
                <button id="rsvp_submit">SEND RSVP</button>
            </div>
    ...
    <footer>
        <p>crafted by <span><img src="<?= base_url('public/AssetsGuest/image/watermark.svg')?>" width="15"></span>digieplan © 2023</p>
    </footer>
    <div id="musicPlayer">
    ...
    <nav id="navbar">
        <ul>
            <li class="nav" id="bride_button"><img src="<?= base_url('public/AssetsGuest/image/bride.svg')?>" height="24"> <div>BRIDE</div></li>
            <li class="nav" id="date_button"><img src="<?= base_url('public/AssetsGuest/image/date.svg')?>" height="24"> <div>DATE</div></li>
            <li class="nav" id="gift_button"><img src="<?= base_url('public/AssetsGuest/image/gift.svg')?>" height="24"> <div>GIFT</div></li>
            <li class="nav" id="rsvp_button"><img src="<?= base_url('public/AssetsGuest/image/rsvp.svg')?>" height="24"> <div>RSVP</div></li>
        </ul>
    </nav>
